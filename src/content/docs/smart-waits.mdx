...
Or copy [`packages/cdat-utils/src/Cdat.ts`](https://github.com/darco81/cdat-pattern/tree/main/packages/cdat-utils) directly into your repo if you prefer not to depend on a package.
