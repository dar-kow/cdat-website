...
> **Deliverable**: `~/dev/dar-kow/cdat-website/SPRINT-2-QA-REPORT.md` + optional polish branch
...
`github.com/dar-kow/cdat-pattern` — 87 commits at HEAD `7dad025`. **DO NOT TOUCH.**

**Forbidden**:
- `cd ~/dev/dar-kow/cdat-pattern && git anything`
- Modify any file in `~/dev/dar-kow/cdat-pattern/`

**If reading needed**: `curl -s https://raw.githubusercontent.com/dar-kow/cdat-pattern/main/<path>` — read-only.
...
Write to `~/dev/dar-kow/cdat-website/SPRINT-2-QA-REPORT.md`.
